...
/**
 * Active Record interface that can be implemented to access a database.
 *
...
class MY_Model extends CI_Model implements Active_Record {
    ...
    protected $_tableName;            // Name of the current table
    protected $_keyField;             // name of the current table's primary key
     ...
     */
    function __construct($tablename = null, $keyfield = 'userID') {
        parent::__construct();
